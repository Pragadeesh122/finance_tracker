...
export function StepUpSIPSection({
    ...
    inputs.years > 0
      ? (() => {
          ...
          for (let year = 1; year <= inputs.years; year++) {
            ...
            currentAmount = bankerRound(
              currentAmount * (1 + inputs.stepUpPercentage / 100)
            );
          }
          return total;
        })()
  ...
  const totalInvestmentRegular =
    inputs.initialMonthlyAmount * inputs.years * 12;
    ...
    <div className='space-y-6'>
      <Card className='p-6'>
        ...
        <div className='flex items-center gap-3 mb-6'>
          ...
          <div>
            ...
            <p className='text-sm text-muted-foreground'>
              Grow your SIP investments annually
            </p>
          </div>
        </div>
        ...
        <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-3'>
          ...
          <div className='rounded-lg bg-secondary/30 border border-border p-4'>
            <div className='text-sm font-medium text-accent'>Total Returns</div>
            <div className='mt-1 text-2xl font-semibold text-accent'>
        ...
        {inputs.years > 0 && inputs.stepUpPercentage > 0 && (
          <div className='mt-6 rounded-lg bg-secondary/50 border border-border p-4'>
            ...
            <div className='mt-1 text-xl font-semibold text-foreground'>
              {formatCurrency(
                inputs.initialMonthlyAmount *
                  Math.pow(1 + inputs.stepUpPercentage / 100, inputs.years - 1)
              )}
            ...
            <div className='space-y-4'>
              ...
              <div className='space-y-3'>
                <div className='flex justify-between'>
                  ...
                  <span className='font-medium'>
                    {formatCurrency(totalInvestmentRegular)}
                  </span>
                </div>
                <div className='flex justify-between'>
                  <span className='text-sm text-slate-600 dark:text-slate-400'>
          ...
          <div className='flex items-center justify-between mb-4'>
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 ${
                showBreakdown ? "bg-accent" : "bg-slate-200 dark:bg-slate-700"
              }`}
