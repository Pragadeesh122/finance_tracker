...
import {CalculatorTypeIcons, IconSizes, IconColors} from "./CalculatorIcons";
        ...
        <div className='flex items-center gap-3 mb-6'>
          ...
          <div>
            ...
            <p className='text-sm text-muted-foreground'>
              Plan your secure retirement future
            </p>
          </div>
        </div>
          ...
          <div className='flex flex-wrap gap-2'>
            {[
              ...
              <button
                key={preset.amount}
                onClick={() =>
                  onInputChange("currentMonthlyExpenses", preset.amount)
                }
        ...
        {yearsToRetirement > 0 && (
          <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-6'>
            ...
            <div className='rounded-lg bg-accent/5 border-2 border-accent p-4 hover:bg-accent/10 transition-colors'>
              ...
              <div className='text-xs text-accent/80 mt-1'>Start investing</div>
            </div>
          ...
          <div className='space-y-4'>
            <div className='grid gap-4 sm:grid-cols-2'>
              ...
              <div className='space-y-3'>
                ...
                <div className='space-y-2 text-sm'>
                  ...
                  <div className='flex justify-between'>
                    <span className='text-slate-600 dark:text-slate-400'>
                      Annual Expenses (Inflation Adj.):
                    </span>
                    <span className='font-medium'>
                      {formatCurrency(futureMonthlyExpenses * 12)}
                    </span>
                  </div>
                  <div className='flex justify-between'>
                    <span className='text-slate-600 dark:text-slate-400'>
            ...
            <div className='mt-6 rounded-lg bg-secondary/50 border border-border p-4'>
              ...
              <div className='text-sm text-muted-foreground space-y-1'>
                ...
                <div>
                  • Review and increase SIP amount annually with salary
                  increments
                </div>
                <div>
                  • Consider healthcare inflation (typically higher than general
                  inflation)
                </div>
                <div>
                  • Plan for emergency fund equivalent to 1-2 years of expenses
                </div>
                <div>
                  • Diversify investments across equity and debt for retirement
                  portfolio
                </div>
                <div>
                  • Consider post-retirement income sources like rental income
                  or pensions
                </div>
              </div>
            </div>
